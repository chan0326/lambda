...
import com.erich.api.enums.ArticleRouter;
...
public class ArticleView {
    ...
    public static void main(Scanner sc) throws SQLException {
        ...
        while (ArticleRouter.execute(sc));
//        excute(sc, articleController);


    }
}

//    private static void excute(Scanner sc, ArticleController articleController) throws SQLException {
//        while (true) {
